...
Linking such directories in the file-system (as symlinks, for example) should work. In order to make the contents of such files adapt to the particular book being built, consider making use of the [[#templating-systems][templating systems]] feature of this configuration.
