...
| =--process-figuremark= | Enable the processing of [[https://github.com/mattgemmell/pandoc-publish/blob/main/demo-nonfiction/figuremark.pdf][FigureMark]] blocks. Disabled by default. |
