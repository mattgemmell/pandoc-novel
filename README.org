...
Python is only needed if you want to make use of [[#metadata-and-placeholder-support][the placeholders feature]]. If you don't need it, just disable the relevant line in the =build-book.sh= script. (Note: if you /do/ want to use the feature, this configuration assumes that your python executable is python3. If it isn't, tweak the =build-book.sh= script appropriately. If you install python via homebrew, you'll be fine.)
